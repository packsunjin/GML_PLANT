...
**① 선행연구가 쓰는 값** — 식물 전기신호를 머신러닝으로 분류한 연구들은 신호를
**8~15초** 단위로 자르고 **0.1~20Hz**로 대역을 제한합니다. 식물의 활동전위·변동전위가
주로 그 안에 있기 때문입니다.
...
겹치는 구간이 **0.5~20Hz**이고, 창은 선행연구 범위의 가운데인 **10초**로 잡았습니다.
스텝은 2초(80% 겹침)라 짧은 수집에서도 이미지 장수가 확보됩니다.
...
| 지속 시간 | 수 초 ~ 수백 초 | **0.5Hz 위**만 통과 (≈2초보다 느린 성분은 지워짐) |

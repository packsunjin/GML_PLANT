...
# ── 전극 → 폴로어 → ADS1115 ────────────────────────────────────
TX, FX, AX = 68, 150, 296
ROWS = [(48, "E1", "stem, upper"), (96, "E2", "stem, lower"),
        (162, "E3", "dummy"), (210, "E4", "dummy")]
...
b.append(w(BX, TOP, BX, TOP + 20))
for i, ry in enumerate([TOP + 20, MY + 20]):
    b.append(f'<rect x="{BX-7}" y="{ry}" width="14" height="46" fill="none" '
             f'stroke="{K}" stroke-width="{SW}"/>')
    b.append(t(BX + 12, ry + 27, "100 kΩ", 8.2))
b.append(w(BX, TOP + 66, BX, MY + 20))
b.append(w(BX, MY + 66, BX, GND))

# 중점 -> 흙 전극
b.append(dot(BX, MY))
b.append(w(BX, MY, BX + 82, MY))
b.append(term(BX + 85, MY))
b.append(t(BX + 92, MY - 4, "soil", 8.8))
b.append(t(BX + 92, MY + 6, "reference", 7.4))
...
b.append(t(6, 254, "MCP6002 × 2 (unity-gain buffers) · 3.3 V single supply · 0.1 µF decoupling", 8.2))
